---
title: "Distributed Modular Monolith Point Of Sale Go"
...
| **API Docs** | Swagger UI | Interactive API documentation (echo-swagger) |
...
| `just generate-swagger` | Regenerate Swagger API documentation (swag) |
