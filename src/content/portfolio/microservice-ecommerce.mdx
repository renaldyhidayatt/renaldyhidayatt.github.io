---
title: "Distributed Modular Microservice E-Commerce Platform"
excerpt: "Backend e-commerce berskala produksi berbasis modular-microservice yang dibangun dengan Go, gRPC, PostgreSQL, Kafka, dan Kubernetes, dilengkapi tumpukan observabilitas penuh."
date: "2026-02-14"
tags: [
  "golang", "grpc", "postgresql", "kafka", "kubernetes", "docker", "redis",
  "prometheus", "grafana", "opentelemetry", "jaeger", "loki", "sqlc", "goose"
]
status: "selesai"
image: "/portofolio/distributed-microservice-ecommerce-grpc/MicroserviceEcommerce.png"
---

# Distributed Modular Microservice E-Commerce Platform

A production-grade, highly resilient, and fully observable **microservices e-commerce backend** built in **Go (Golang)**. Designed around domain-driven service boundaries following Clean Architecture principles, it distributes transactional workloads across self-contained, micro-deployable services while maintaining high consistency and performance.

Each e-commerce and identity business domain — Users, Roles, Cards, Merchants, Saldo, Topups, Transactions, Transfers, Withdrawals — lives in its own self-contained microservice. These services communicate synchronously via lightweight **gRPC** protocols and asynchronously using **Apache Kafka** event propagation, exposing a unified entry point through a **REST API Gateway** built with **Echo** and NGINX.
...
Our enterprise Kubernetes infrastructure resides inside the dedicated `ecommerce` namespace, configuring scalable nodes utilizing Horizontal Pod Autoscalers.
...
## Source Code
[View on GitHub](https://github.com/MamangRust/microservice-ecommerce-grpc)
