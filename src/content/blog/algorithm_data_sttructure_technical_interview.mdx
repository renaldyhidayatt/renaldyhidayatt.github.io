...
- [Key Categories of Algorithms and Data Structures](#key-categories-of-algorithms-and-data-structures)
  - [1. Dynamic Programming](#1-dynamic-programming-1d_dp)
  - [2. Array and String Manipulation](#2-array-and-string-manipulation-array_string)
  - [3. Backtracking](#3-backtracking-backtracking)
  - [4. Binary Search](#4-binary-search-binary_search)
  - [5. Binary Trees and Binary Search Trees](#5-binary-trees-and-binary-search-trees-binary-tree-general-binary_search_tree)
  - [6. Bit Manipulation](#6-bit-manipulation-bit_manipulation)
  - [7. Divide and Conquer](#7-divide-and-conquer-divide_conquer)
  - [8. Graphs](#8-graphs-graph_bfs-graph_general)
  - [9. Hash Maps](#9-hash-maps-hashmap)
  - [10. Heap](#10-heap-heap)
  - [11. Intervals](#11-intervals-intervals)
  - [12. Kadane’s Algorithm](#12-kadanes-algorithm-kadane_algorithm)
  - [13. Linked Lists](#13-linked-lists-linked_list)
  - [14. Math and Number Theory](#14-math-and-number-theory-math_leetcode)
  - [15. Matrix](#15-matrix-matrix)
  - [16. Sliding Window](#16-sliding-window-sliding_window)
  - [17. Stacks and Queues](#17-stacks-and-queues-stack)
  - [18. Tries](#18-tries-trie)
  - [19. Two Pointers](#19-two-pointers-two_pointer)
