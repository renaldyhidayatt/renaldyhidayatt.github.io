...
const Navbar = () => {
    ...
    return (
        <nav className="hidden md:block border-b border-border bg-background/80 backdrop-blur-sm sticky top-0 z-50 transition-colors">
            <div className="max-w-4xl mx-auto px-6 py-4">
                <div className="flex items-center justify-between">
                    <Link
                        to="/"
                        className="flex items-center space-x-2 text-xl font-serif font-semibold text-foreground hover:text-primary transition-colors"
                    >
                        <MinecraftIcon />
                        <span>RH</span>
                    </Link>
