...
class NQueens:
    def solve_n_queens(self, n: int) -> List[List[str]]:
        ...
        self.backtrack(result, board, 0, set(), set(), set())
        return result

    def backtrack(self, result: List[List[str]], board: List[List[str]], row: int,
                  cols: Set[int], diag1: Set[int], diag2: Set[int]):
        if row == len(board):
        ...
        for col in range(len(board)):
            ...
            self.backtrack(result, board, row + 1, cols, diag1, diag2)
