...
if __name__ == "__main__":
    me = MajorityElement()
    nums = [2, 2, 1, 1, 1, 2, 2]
    print(me.majorityElement(nums))  # Output: 2
```
...
The **Majority Element** problem is efficiently solved using the **Boyer-Moore Voting Algorithm**, achieving `O(n)` time and `O(1)` space complexity. 🚀
